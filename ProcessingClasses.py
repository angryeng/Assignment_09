...
class DataProcessor:
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        Args:
            ...
            cd (DC.CD): cd object the tracck gets added to.
        ...
        """
        tracknum, tracktitle, tracklen = track_info
        try:
            tracknum = int(tracknum)
        except:
            raise Exception('The track number must be an Integer!')
        track = DC.Track(tracknum, tracktitle, tracklen)
        cd.add_track(track)

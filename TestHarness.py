...
# DOranski, 2020-Mar-22, Updated file with new data
#------------------------------------------#
...
lstOfCDObjects = []
file_name = ['CD.txt', 'Track.txt']

print('\n\nTesting Track class')
print(DC.Track.__doc__)
trk1 = DC.Track(1, 'Test1', '0:00')
trk2 = DC.Track(2, 'Test2', '99:99')
print(trk1)
print('record for file:', trk1.get_record())

print('\n\nTesting CD class')
print(DC.CD.__doc__)
cd1 = DC.CD(1, 'Test1', 'Artist1')
print(cd1)
...
PC.DataProcessor.add_CD((3, 'Smash', 'The Offspring'), lstOfCDObjects)
print('Inventory:')
for item in lstOfCDObjects:
    print(item)
